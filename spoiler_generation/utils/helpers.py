...
def create_argparse():
    ...
    # Adding Argument
    parser.add_argument("--train-data", type=str, help="Path to training data", required=False)
    parser.add_argument("--val-data", type=str, help="Path to validation data", required=False)
